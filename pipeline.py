...
with st.sidebar:
    st.write("###User Inputs here.....")
    Day_of_week = st.selectbox('Day of Week', ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday'])
    Age_band_of_driver = st.selectbox('Age Band of Driver', ['17-20', '21-25', '26-30', '31-35', '36-40', '41-45', '46-50', '51-55', '56-65',
                                       '66-75', 'Over 75'])
    ...
    Work_of_casuality = st.selectbox('Work of Casualty',
                                     ['Driver', 'Other', 'Unemployed', 'Employee', 'Self-employed', 'Student',
                                      'Unknown'])
    Fitness_of_casuality = st.selectbox('Fitness of Casualty', ['Normal', 'Deaf', 'Other', 'Blind'])
    Pedestrian_movement = st.selectbox('Pedestrian Movement', ["Not a Pedestrian",
                                                               ...
                                                               "Stationary in carriageway - not crossing  (standing or playing)"])
